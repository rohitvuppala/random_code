...
real(8) :: T,rho1,rho2,kf,hi,ei,e1,e2,engi,eng,eng1,eng2,h1,h2,d1dt,gp,gr,dg,keq,dt,deng,dengdT,time,res0, &
           res,Told
integer :: nitermax,nmax,n,i,j
rho1=0d0
rho2=0d0
T=Ti
dt= 2.4e-3
...
open (unit = 2, file = "data_for_graph.dat")
...
res = (d1dt/res0)
time = time + dt
print *, i,time,rho1/rhoi,T
!print*, T,d1dt

write(2,*) i,time,rho1/rhoi,T

if ((res<1e-6).AND.(abs(T-Told)<1e-6)) then
   exit
end if
